...
export const Skills = () => {
    const mainTechs = [
        ...
        {
            name: "C#", svg: (
                <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 -1.43 255.58 290.11">
        ...
        <section className={style.bodySection} id="sobre-mi">
            ...
            <div className={style.carouselWrapper}>
                <div className={style.carouselTrack}>
                    {[...mainTechs, ...mainTechs].map((tech, index) => (
            ...
            <div className={style.carouselWrapper}>
                <div className={`${style.carouselTrack} ${style.carouselReverse}`}>
                    {[...exploringTechs, ...exploringTechs].map((tech, index) => (
                        <div key={index} className={style.skillCard}>
                            {tech.svg}
                            <span>{tech.name}</span>
                        </div>
