...
import perfil from "../../../public/img/JosCaz.png"
...
export const Body = () => {
    ...
    return (
        <section className={styles.bodySection} id="inicio">
            <div className={styles.introSection}>
                ...
                <Link><button className={styles.btnContact} onClick={openModal}>
